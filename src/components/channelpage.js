                ...
                <Col xs="9">
                    <Card>
                        ...
                        <CardBody>
                            ...
                            <CardText>Category: <Link to="/category" onClick={() => props.setCategoryPage(channel.category.id)} className="catLink">{channel.category.title}</Link></CardText>
                        </CardBody>
                    </Card>
                </Col>
            </Row>
